...
a <- ts(airlines$Passengers,frequency = 12,start=c(1995))
View(a)
train<-a[1:84]
test<-a[85:96]
...
# From 'table' and 'table1' having alpha,beta,gamma with HW Functions( Holt-Winter Additive method) have least MAPE
